...
AppFeature::AppFeature(String pText, uint8_t pFeatureGroup, uint8_t pFeature){
  iFeatureGroup = pFeatureGroup;
  sText = pText;
  iFeature = pFeature;
}

AppFeature::AppFeature(String pText, uint8_t pFeatureGroup, uint8_t pFeature, bool pSelect){
  iFeatureGroup = pFeatureGroup;
  sText = pText;
  iFeature = pFeature;
  bSelected = true;
